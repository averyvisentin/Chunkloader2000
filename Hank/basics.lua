...
function basics.Current(coordinates, facing)
    if coordinates then
...
function basics.UpdatePosition(direction)
...
function basics.In_location(xyzo, location)            
...
function basics.In_area(xyz, area) --checks if xyz is in an area, defined by a table with min and max xyz
...
function basics.PrintBlockTable()
